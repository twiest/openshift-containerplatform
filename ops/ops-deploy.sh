...
time azure group deployment create --name "opsazuretest01deployment" --resource-group=opsazuretest01rg-eastus --template-file azuredeploy.json -e ../../azure/azuredeploy.parameters.json
